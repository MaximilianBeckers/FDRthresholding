...
**As confidence maps are almost binary and have huge contrast, they might look very sharp and edged. For visualization the representation can be easily improved, for example in Chimera by 
