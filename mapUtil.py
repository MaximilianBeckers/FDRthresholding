...
#--------------------------------------------------------------------------------------------------
def makeDiagnosticPlot(map, windowSize, padded, locscale):

	#*************************************************************
	#*** function to make diagnostic plot of noise estimation ****
	#*************************************************************

	print("Generating diagnostic plot of noise estimation. Please have a look in 'diag_image.mrc' that the molecule does not fall into the region used for background noise estimation.")
